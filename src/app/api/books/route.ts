...
export async function POST(request: NextRequest) {
    try {
        ...
        if (!body.title || !body.description || !body.author || !body.category || !body.price || !body.stock) {
            return NextResponse.json(
        ...
        const response = await fetch(`${API_URL}/api/v1/books`, {
            ...
            body: JSON.stringify({ title: body.title, description: body.description, author: body.author, category: body.category, price: body.price, image: body.image, stock: body.stock }),
        });
