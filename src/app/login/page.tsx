        ...
        <div className="flex min-h-screen flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-6">
                <p className="text-center text-sm text-gray-500">
                    Não possui conta?{' '}
                    <a href="/signup" className="-6 underline text-custom-main-green hover:text-custom-auxiliar-green">
                        Clique aqui
                    </a>
                </p>
            </div>
        ...
        <div>
            <div className='bg-custom-auxiliar-green p-4 rounded-2xl'>
                <div className='px-10 pb-10 pt-24'>
                    <p className='text-3xl text-white font-bold text-center'>Bem-vindo(a) de volta ao the Library!</p>
                    <p className='text-white text-base'>Entre com sua conta para utilizar a plataforma</p>
